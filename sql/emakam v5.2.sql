...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2018 at 10:18 PM
...
(6, 12312, 'XXX-B-12312', 4, '-7.952787408292898', '112.61509476369804'),
...
(101, 14, '-7.952693872580954', '112.61287581854094'),
(102, 14, '-7.953023267690795', '112.6126344197296'),
(103, 14, '-7.9533154728087325', '112.61275780134429'),
(104, 14, '-7.953352662536078', '112.6132996075653'),
(105, 14, '-7.953028580512986', '112.6135356419586'),
(106, 14, '-7.952699185407407', '112.61321914129485');
...
(4, 'fadlan', '$2y$10$2kbKC00C1vXgY5UxdkkXCO3i1xH8AUj9CYCkSLfVg5sm9mujlqxwW', 1);
...
--
ALTER TABLE `blok_makam`
  MODIFY `id_blok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `polygon`
  MODIFY `id_polygon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
