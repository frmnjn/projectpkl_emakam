...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2018 at 01:42 AM
...
(1, 'Manusia', 'Bumi', '2018-07-01 00:00:00', 1, 1, 'Nabi Adam', 'seberangnya abdul', '123456789', '+62'),
(2, 'Abdul', 'Sigura-gura', '2018-07-03 00:00:00', 1, 1, 'Dulab', 'idem', '6123123', '1241'),
(3, 'Bedu', 'Bendungan Hilir', '2018-07-01 00:00:00', 1, 3, 'Beni', 'idem', '4123412', '3211'),
(4, 'Cindy', 'Kerto-Kerto', '2018-07-14 00:00:00', 1, 2, 'Chakra', 'idem', '121234', '6123'),
...
(18, 'asdasdasdad', 'asdasdasd', '2018-07-12 00:00:00', 0, 1, 'asdasd', 'adasd', 'asdasd', 'asdasd'),
(19, 'qasdasf', 'asdqwfs', '2018-07-09 00:00:00', 2, 1, 'aaaaaaaaaaa', 'bbbbbbbbbbbb', '111111111111', '222222222'),
(20, 'asdqwd', 'qwdqwe12', '2018-07-04 00:00:00', 2, 2, '12dwasdq', '21dwasd', '3333333333', '44444444444'),
(21, 'qwe', 'wqwe', '2018-07-10 00:00:00', 2, 2, 'qweqwe', 'qweqwe', '2222222222', '11111111'),
(22, 'Yukimak', 'disini aja', '2018-07-18 00:00:00', 1, 5, 'kumikay', 'asdasd', '51345123', '1231523123'),
(23, 'dummy1', 'alamat dummy1', '2018-08-15 00:00:00', 0, 1, 'dudul', 'alamat dummy 1', '12312', '1231523123');
...
--
ALTER TABLE `makam`
  MODIFY `id_makam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `penghuni_makam`
--
ALTER TABLE `penghuni_makam`
  MODIFY `id_penghuni_makam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `role_tpu`
--
ALTER TABLE `role_tpu`
  MODIFY `id_role_tpu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tpu`
--
ALTER TABLE `tpu`
  MODIFY `id_tpu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
