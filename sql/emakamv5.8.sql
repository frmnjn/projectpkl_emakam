...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2018 at 01:36 PM
...
INSERT INTO `dokumen` (`id`, `nama_almarhum`, `nama_pewaris`, `tgllhr_ahli_waris`, `email`, `pekerjaan_ahli_waris`, `file_ktp`, `file_kk`, `file_surat_izin`, `kelengkapan_dokumen`, `status`) VALUES
(15, 'alm1', 'asd', '2018-09-17 11:44:00', '', '', 'public/files/file.jpg', 'public/files/photo.jpg', 'public/files/file.jpg', 'Lengkap', 'Menunggu Persetujuan Kepala Kecamatan'),
(16, 'alm2', 'asd', '2018-09-17 11:44:00', '', '', 'public/files/photo.pdf', 'public/files/file.pdf', 'public/files/file.jpg', 'Lengkap', 'Menunggu Persetujuan Kepala Kecamatan'),
(18, 'dokumen1', 'ahliwarisdokumen1', '2018-09-17 11:44:00', 'mail.defailt@mail.com', '', 'public/files/6oy7JBLYXrYqVkluCgwTDjyaxnRm48wCAqCqUlQm.png', 'public/files/aca9hPxhF93N7I9qvK8K8wzygC4vohzKy9U96l1e.jpeg', 'public/files/file.jpg', 'Dokumen Kurang', 'Menunggu Persetujuan Kepala UPT'),
(19, 'baru', 'ahli waris dummy 1', '2018-09-17 11:44:00', 'mail.defailt@mail.com', '', 'public/files/Em02HNsyEZH2sdk65oXcEU8BtFm0rCZQsFdYN0MM.png', 'public/files/uy1eyDGEPGjGwiPgkXqNENMHDrGPtUzW9oLo74ts.jpeg', 'public/files/file.jpg', 'Lengkap', 'Proses Selesai'),
(22, 'dokumen baru', 'ahli waris dummy 1', '2018-09-26 00:00:00', 'fadhlanmuhamad@gmail.com', 'programmer', 'public/files/PBGHrLY6KCwEOQhGaciS8JerxrR1PXg0JoAYoWF6.png', 'public/files/rJsFgub3wrX3pxQ4iymkhFFrwAQvdoujRPl9Ccmv.jpeg', 'public/files/WA5j80Sof7yYRzEYfuCjA8zGCMwT8sJxugxkh3gt.jpeg', 'Lengkap', 'Proses Selesai'),
(23, 'dokumen1', 'test', '2018-09-19 00:00:00', 'fadhlanmuhamad@gmail.com', 'programmer', 'public/files/MyUwyrmxxmERkGLFq2TCYmN9nRo0Im0eC8gbP0zK.png', 'public/files/V0dUhzAT9bajs0n5d10sPSG05QJ73wUimYynRuPE.jpeg', 'public/files/xOfKCXiVV8s8f5APhe81r9sSRSXwx06UbwYWBYij.jpeg', 'Lengkap', 'Proses Selesai');
...
(1, 'Manusia', 'Laki-Laki', 'Bumi', '2018-09-17 11:28:09', '2018-07-01 00:00:00', '2018-09-17 11:18:43', 'Ditimpa', 1, 'Nabi Adam', 'seberangnya abdul', '123456789', '+62'),
...
--
ALTER TABLE `penghuni_makam`
  MODIFY `id_penghuni_makam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
