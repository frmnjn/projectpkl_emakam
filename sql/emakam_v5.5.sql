...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2018 at 04:19 PM
...
CREATE TABLE `dokumen` (
  ...
  `acc_kepalatpu` varchar(15) DEFAULT NULL,
  `acc_kepaladinas` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `dokumen` (`id`, `nama_almarhum`, `nama_pewaris`, `file_ktp`, `file_kk`, `acc_kepalatpu`, `acc_kepaladinas`) VALUES
(15, 'asd', 'asd', 'public/files/5B1Rmq4GvEqwy5XDdM4DlwsXrPR0uUXkiJWOukbC.png', 'public/files/iOR80LqM3QTO7rYTkiCW3AwXy84RBcs2gu5S9fUY.png', 'Accepted', 'Accepted'),
(16, 'asd', 'asd', 'public/files/rwjlmFCMLwNUZaXJlQ41U7ZT94RJVh6uoN0fslCM.png', 'public/files/aeLK67jlcigHUVTYNDBpdNzAr17mj2GpFyTptc6m.jpeg', 'Accepted', 'Pending');
