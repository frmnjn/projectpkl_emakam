...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2018 at 08:22 PM
...
(15, 'alm1', 'asd', '', 'public/files/file.jpg', 'public/files/photo.jpg', 'Lengkap', 'Proses Selesai'),
(16, 'alm2', 'asd', '', 'public/files/photo.pdf', 'public/files/file.pdf', 'Lengkap', 'Menunggu Persetujuan Kepala Dinas'),
(18, 'dokumen1', 'ahliwarisdokumen1', 'mail.defailt@mail.com', 'public/files/BoQQO3NeT7Yz7uP6FC4WjMMOvizHK5tFUf0UkPxr.png', 'public/files/WYc1i4GLgLW41ELOXF4wEDQZNm4zzHSLhV1aLPia.png', 'Dokumen Kurang', 'Menunggu Persetujuan Kepala UPT'),
(19, 'baru', 'ahli waris dummy 1', 'mail.defailt@mail.com', 'public/files/fiAqBV52vIz6wGjNDq10XXlCBFdx0mUFQSYZ1Ust.jpeg', 'public/files/2gSKNC5kdbMxRoMbDwccl3MffYGBhC87y5GVaIhN.jpeg', 'Lengkap', 'Menunggu Persetujuan Kepala Kecamatan'),
(20, 'hehe', 'hhe', 'mail.defailt@mail.com', 'public/files/ehiKzi9tpwWuXmorFA4ygHRPvmsFgrL7legbteKz.png', 'public/files/z9wRbUHwxC0V7LuYxge6ZV4uYEO8gYSbV3QmGPke.jpeg', 'Dokumen Kurang', 'Menunggu Persetujuan Kepala UPT'),
(21, 'hehe', 'hhe', 'mail.defailt@mail.com', 'public/files/ee7oTXBi5AvDy4sfM3w14x11fA1PbMltENy2bXCS.png', 'public/files/tQAE9ejb0n4uZHeDxQZNkRE3jfwCKIGvdmbT59rt.jpeg', 'Dokumen Kurang', 'Menunggu Persetujuan Kepala UPT'),
(22, 'nama', 'nama ahli waris', 'mail.defailt@mail.com', 'public/files/v6ZrPTiAPUalWzmAXqxxcyc6cwxTKlQ6V0UKF4Mf.png', 'public/files/3lPtaDkj2i2NoVa5ErMyd3GMQMcykYKFleV7CCXo.jpeg', 'Dokumen Kurang', 'Menunggu Persetujuan Kepala UPT');
...
(26, 'test', 'test', '2018-08-06 00:00:00', 'Expired', 10, 'test', 'test', '12', '123'),
(27, 'test', 'test', '2018-08-06 00:00:00', 'Expired', 10, 'test', 'test', '12', '123'),
(28, 'test', 'test', '2018-08-06 00:00:00', 'Expired', 10, 'test', 'test', '12', '123'),
(38, 'dummy1', 'alamat dummy1', '2018-10-04 00:00:00', 'Diperpanjang', 3, 'ahli waris dummy 1', 'alamat dummy 2', '51345123', '123123'),
(56, 'dokumen1', 'alamat dokumen1', '2018-09-02 00:00:00', 'Ditimpa', 1, 'ahliwarisdokumen1', 'adhliwarisdokumen1', '51345123', '1231523123'),
(57, 'baru', 'baru', '2018-09-02 00:00:00', 'Ditimpa', 4, 'ahli waris dummy 1', 'adhliwarisdokumen1', '51345123', '1231523123'),
(59, 'hehe', 'hehe', '2018-08-31 00:00:00', 'Expired', 10, 'hhe', 'hehe', '123', '123'),
(60, 'nama', 'alamat', '2018-08-31 00:00:00', 'Expired', 10, 'nama ahli waris', 'alamt ahli', '123', '123');
...
(7, 'kupt', '$2y$10$4UCNG1OVRl6PCgUdtQlLIeekK7AkFiSngdbVfZSQyPdJz6w9StAiS', 2),
(8, 'kdinas', '$2y$10$W9Bg8Y7T2kXpw1JYfE0Mx.JCxpkYTRoJiDVPjqI6hq7yYwixgyrVG', 3),
(9, 'kpkec', '$2y$10$u1qd.yMckm1C8Sk5mMAn3ON9PhGWl5CzE/62efgAPFtgoYYmIJxFO', 4),
(10, 'adminkecamatan', '$2y$10$mK/i1uEQupI9beeXb9bCMOsB0n4wlH8BM2wJsWq1QXX9nER1XCufG', 5);
...
--
ALTER TABLE `penghuni_makam`
  MODIFY `id_penghuni_makam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
