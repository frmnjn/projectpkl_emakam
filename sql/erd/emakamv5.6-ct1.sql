...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2018 at 04:11 AM
...
(15, 'alm1', 'asd', '', 'public/files/file.jpg', 'public/files/photo.jpg', 'Lengkap', 'Menunggu Persetujuan Kepala UPT'),
(16, 'alm2', 'asd', '', 'public/files/photo.pdf', 'public/files/file.pdf', 'Lengkap', 'Menunggu Persetujuan Kepala Dinas'),
(18, 'dokumen1', 'ahliwarisdokumen1', 'mail.defailt@mail.com', 'public/files/6oy7JBLYXrYqVkluCgwTDjyaxnRm48wCAqCqUlQm.png', 'public/files/aca9hPxhF93N7I9qvK8K8wzygC4vohzKy9U96l1e.jpeg', 'Dokumen Kurang', 'Menunggu Persetujuan Kepala UPT'),
(19, 'baru', 'ahli waris dummy 1', 'mail.defailt@mail.com', 'public/files/Em02HNsyEZH2sdk65oXcEU8BtFm0rCZQsFdYN0MM.png', 'public/files/uy1eyDGEPGjGwiPgkXqNENMHDrGPtUzW9oLo74ts.jpeg', 'Lengkap', 'Menunggu Persetujuan Kepala Kecamatan');
...
(7, 'kupt', '$2y$10$kVYHl5jauPSNV2ZUSRpIKOfTGgVRPiDqT0ugms1Ic3mDwxQvsLS/W', 2),
(8, 'kdinas', '$2y$10$2PbfNw3wqPSSndywSta8HOg0CyiHgikJMZ./7Wx9EhRa2LV00hF1.', 3),
(9, 'kpkec', '$2y$10$CjCT0X3SJYg1nAnYMaTp2OuqJboLSrNw5N1JABEVJKJIWTONggz7G', 4);
...
--
ALTER TABLE `penghuni_makam`
  MODIFY `id_penghuni_makam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
