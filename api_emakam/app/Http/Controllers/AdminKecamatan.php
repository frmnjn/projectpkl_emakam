...
class AdminKecamatan extends Controller{
	...
	function cetak_surat_perizinan(Request $request){
        ...
        $nama_kecamatan = strtoupper($view[0]->nama);
        $nama_kecamatan_normal = $view[0]->nama;
        $alamat_kecamatan = $view[0]->alamat_kecamatan;
        $no_telp_kecamatan = $view[0]->no_telp_kecamatan;
        $kode_pos_kecamatan = $view[0]->kode_pos_kecamatan;
        $website_kecamatan = $view[0]->website_kecamatan;
		...
		Fpdf::Cell(45);
		Fpdf::SetFont("Times","B","14");
		Fpdf::Cell(133,4.5,"KECAMATAN $nama_kecamatan",0,1,"C");
		Fpdf::Cell(45);
		Fpdf::SetFont("Times","B","10");
		Fpdf::Cell(133,4.5,"$alamat_kecamatan Telepon $no_telp_kecamatan",0,1,"C");
		Fpdf::Cell(45);
		Fpdf::SetFont("Times","","10");
		Fpdf::Cell(133,4.5,"$website_kecamatan",0,1,"C");
		Fpdf::Cell(45);
		Fpdf::Cell(120,4.5,"",0,0,"C");
		Fpdf::Cell(13,4.5,"Kode Pos $kode_pos_kecamatan",0,1,"R");
		...
		Fpdf::Cell(0,7,"",0,1,"R");
		Fpdf::SetFont("Times","B","10");
		Fpdf::Cell(0,4.5,"KEPUTUSAN CAMAT $nama_kecamatan KOTA MALANG",0,1,"C");
		...
		Fpdf::Cell(0,4.5,"CAMAT $nama_kecamatan,",0,1,"C");
		Fpdf::Cell(0,3,"",0,1,"C");
		Fpdf::Cell(10);
		Fpdf::SetFont("Times","","10");
		...
		Fpdf::MultiCell(140,4.5,"Bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a dan b perlu menetapkan Keputusan Camat $nama_kecamatan_normal tentang Izin Penggunaan Tanah Makam/Makam Tumpangan",0,"J",false);
		...
		Fpdf::Cell(5,4.5,":",0,0,"L");
		Fpdf::MultiCell(140,4.5,"KEPUTUSAN CAMAT $nama_kecamatan TENTANG IZIN PENGGUNAAN TANAH MAKAM/TANAH TUMPANGAN",0,"J",false);
		Fpdf::Cell(10);
		...
		Fpdf::Cell(5,4.5,":",0,0,"L");
		Fpdf::MultiCell(140,4.5,"Keputusan Camat $nama_kecamatan_normal ini mulai berlaku pada tanggal ditetapkan.",0,"J",false);
		...
		Fpdf::Cell(115);
		Fpdf::MultiCell(70,4.5,"CAMAT $nama_kecamatan KOTA MALANG,",0,"L",false);
		Fpdf::Cell(115);
