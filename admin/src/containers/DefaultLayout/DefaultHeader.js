...
class DefaultHeader extends Component {
  ...
  fetchnotif(){
    // fetch('http://178.128.81.243/api/notifikasi/view?token='+ sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user'))
    //   .then(response => {
    //     return response.json()
    //   })
    //   .then(
  ...
  notifread(){
    fetch('http://178.128.81.243/api/notifikasi/update?token='+sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user'), {
      method: 'PUT',
      headers: {
