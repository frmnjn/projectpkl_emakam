...
class Makam extends Component {
  ...
  componentDidMount() {
    ...
    fetch("http://149.28.138.217/api/blok/view")
      .then(response => {
  ...
  fetchmakam(){
    fetch("http://149.28.138.217/api/makam/view")
      .then(response => {
        return response.json()
      })
      .then(
  ...
  handleEdit(items){
    ...
    fetch('http://149.28.138.217/api/makam/edit/'+this.state.idmakamaktif, {
      method: 'PUT',
      headers: {
  ...
  handleCreate(){
    ...
    fetch('http://149.28.138.217/api/makam/create', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handleDelete(){
    ...
    fetch('http://149.28.138.217/api/makam/delete/'+this.state.idmakamaktif, {
      method: 'DELETE',
    }).then(
      this.fetchmakam
    ).then(
