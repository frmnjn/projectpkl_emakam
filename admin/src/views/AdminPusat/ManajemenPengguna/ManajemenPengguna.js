...
class ManajemenPengguna extends Component {
  ...
  handleSubmitCreate = event => {
    ...
    fetch('http://178.128.81.243:8000/api/create_user?token='+sessionStorage.getItem('token'), {
      method: 'POST',
      headers: {
  ...
  handleSubmitEdit = event => {
    ...
    fetch('http://178.128.81.243:8000/api/update_user/' + this.state.activeid+"?token="+sessionStorage.getItem('token'), {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handledelete(table_user) {
    fetch('http://178.128.81.243:8000/api/delete_user/' + table_user.id_user+"?token="+sessionStorage.getItem('token')+ '&role=' + sessionStorage.getItem('login_session'), {
      method: 'DELETE'
    })
    .then(
      this.fetchall
