...
class tpu extends Component {
  ...
  handleEdit() {
    ...
    fetch('http://127.0.0.1:8000/api/tpu/edit/' + this.state.idtpuaktif + "?token=" + sessionStorage.getItem('token'), {
      method: 'PUT',
      headers: {
  ...
  handleCreate() {
    ...
    fetch('http://127.0.0.1:8000/api/tpu/create?token=' + sessionStorage.getItem('token'), {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handleDelete() {
    ...
    fetch('http://127.0.0.1:8000/api/tpu/delete/' + this.state.idtpuaktif + "?token=" + sessionStorage.getItem('token'), {
      method: 'DELETE',
    })
    // .then((response) => response.json())
    // .then((responseJson) => {
