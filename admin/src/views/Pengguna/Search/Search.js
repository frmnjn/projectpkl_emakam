...
class Search extends Component {
  ...
  componentDidMount() {
    ...
    fetch("http://api.emakam.tujuhlangit.id/api/penghuni_makam/view_search?token="+sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user')+'&role='+ sessionStorage.getItem('login_session'))
      .then(response => {
      ...
      fetch("http://api.emakam.tujuhlangit.id/api/blok/view_search?token="+sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user')+ '&role=' + sessionStorage.getItem('login_session'))
      .then(response => {
        return response.json()
      })
      .then(
