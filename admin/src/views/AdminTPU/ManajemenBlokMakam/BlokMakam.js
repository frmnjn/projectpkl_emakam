...
class BlokMakam extends Component {
  ...
  fetchtpu(){
    fetch('http://178.128.81.242:8000/api/tpu/view_byUser?token='+sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user'))
  ...
  fetchblok() {
    fetch("http://178.128.81.242:8000/api/blok/view?token=" + sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user'))
      .then(response => {
  ...
  fetchpolygon() {
    fetch('http://178.128.81.242:8000/api/polygon/view?token='+sessionStorage.getItem('token'))
      .then(response => response.json())
      .then(
        (result) => {
          this.setState({
  ...
  createpolygon(items) {
    ...
    fetch('http://178.128.81.242:8000/api/polygon/create?token=' + sessionStorage.getItem('token'), {
      method: 'POST',
      headers: {
  ...
  detelepolygon() {
    ...
    fetch('http://178.128.81.242:8000/api/polygon/delete/'+this.state.idblokaktif + "?token=" + sessionStorage.getItem('token'), {
      method: 'DELETE',
    })
  }
  ...
  handleEdit() {
    ...
    fetch('http://178.128.81.242:8000/api/blok/edit/' + this.state.idblokaktif + "?token=" + sessionStorage.getItem('token'), {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handleCreate() {
    ...
    fetch('http://178.128.81.242:8000/api/blok/create?token=' + sessionStorage.getItem('token'), {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handleDelete() {
    ...
    fetch('http://178.128.81.242:8000/api/blok/delete/' + this.state.idblokaktif + "?token=" + sessionStorage.getItem('token'), {
      method: 'DELETE',
    }).then(
      alert('delete sukses'),
      this.fetchblok
