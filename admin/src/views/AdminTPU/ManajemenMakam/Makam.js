...
class Makam extends Component {
  ...
  fetchmakam(){
    fetch("http://178.128.81.242:8000/api/makam/view?token="+sessionStorage.getItem('token')+'&id_user='+sessionStorage.getItem('id_user'))
      .then(response => {
        return response.json()
      })
      .then(
  ...
  fetchpenghuni(){
    fetch('http://178.128.81.242:8000/api/penghuni_makam/view?token=' + sessionStorage.getItem('token') + '&id_user=' + sessionStorage.getItem('id_user'))
  ...
  handleEdit(items){
    ...
    fetch('http://178.128.81.242:8000/api/makam/edit/'+this.state.idmakamaktif+"?token="+sessionStorage.getItem('token'), {
      method: 'PUT',
      headers: {
  ...
  handleCreate(){
    ...
    fetch('http://178.128.81.242:8000/api/makam/create?token='+sessionStorage.getItem('token'), {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handleDelete(){
    ...
    fetch('http://178.128.81.242:8000/api/makam/delete/'+this.state.idmakamaktif+"?token="+sessionStorage.getItem('token'), {
      method: 'DELETE',
    }).then(
      alert('delte sukses'),
      this.fetchmakam
  ...
  handleDeleteEx(){
    ...
    fetch('http://178.128.81.242:8000/api/makam/delete_ex'+"?token="+sessionStorage.getItem('token'), {
      method: 'DELETE',
    }).then(response => response.json())
    .then(
      (result) => {
